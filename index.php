...
<body>
  ...
  <div>
    ...
    <form name="formimp" id="formimp" method="post">
      <div id="container">
        ...
        <input type="hidden" name="_next" value="http://localhost:8080/majorProject/index.php" id="next">
  ...
  <textarea id="Othertxtarea" rows="4" cols="50" style="visibility: hidden;">
        ...
        <div class="child-container">
          ...
          <!--input type="submit" name="profbtn" id="profbtn" class="btn btn-primary" value="Get Professors" onclick="javascript: form.action='/majorProject/index.php';">
          <input type="submit" name="projbtn" id="projbtn" class="btn btn-primary" value="Other Projects" onclick="javascript: form.action='/majorProject/index.php';"-->
...
if (isset($_POST['profbtn'])) {
  ...
  $theme = $_POST['category'];
  $sql = "SELECT `Professor_Name` FROM `projectinfo_researchareas` WHERE Research_Keywords LIKE '%" . $theme . "%'";
  $result = mysqli_query($conn, $sql);
  $numrows = mysqli_num_rows($result);
